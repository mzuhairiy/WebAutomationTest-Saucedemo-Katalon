...
WebUI.setText(findTestObject('saucedemo.com/Checkout/input Checkout Information_firstName'), 'David')

WebUI.setText(findTestObject('saucedemo.com/Checkout/input Checkout Information_lastName'), '')
...
WebUI.verifyElementPresent(findTestObject('saucedemo.com/Checkout/Alert CO Information/alert_Last Name is required'), 0)
