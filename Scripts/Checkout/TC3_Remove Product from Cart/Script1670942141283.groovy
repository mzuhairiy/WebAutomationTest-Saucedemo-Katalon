...
WebUI.verifyElementPresent(findTestObject('saucedemo.com/Checkout/title Your Cart'), 0)

WebUI.verifyElementPresent(findTestObject('saucedemo.com/Checkout/Div Your Cart/div_YC1'), 0)

WebUI.click(findTestObject('saucedemo.com/Checkout/Button/btn Remove'))

WebUI.verifyElementNotPresent(findTestObject('saucedemo.com/Checkout/Div Your Cart/div_YC1'), 0)

WebUI.click(findTestObject('saucedemo.com/Checkout/Button/btn Continue Shopping'))

WebUI.verifyElementPresent(findTestObject('saucedemo.com/Login/div Inventory Container'), 0)
