...
WebUI.verifyElementPresent(findTestObject('saucedemo.com/Checkout/Button/Button Add to Cart/button_ATC1'), 0)

WebUI.verifyElementNotPresent(findTestObject('saucedemo.com/Checkout/icon Shopping Cart Badge'), 0)
