...
WebUI.setText(findTestObject('saucedemo.com/Checkout/input Checkout Information_firstName'), '')

WebUI.setText(findTestObject('saucedemo.com/Checkout/input Checkout Information_lastName'), 'Jackson')
...
WebUI.verifyElementPresent(findTestObject('saucedemo.com/Checkout/Alert CO Information/alert_First Name is Required'), 0)
