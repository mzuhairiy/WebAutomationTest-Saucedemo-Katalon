...
WebUI.setText(findTestObject('saucedemo.com/Checkout/input Checkout Information_lastName'), 'Zainudeen')

WebUI.setText(findTestObject('saucedemo.com/Checkout/input Checkout Information_postalCode'), '')

WebUI.click(findTestObject('saucedemo.com/Checkout/Button/btn Continue'))

WebUI.verifyElementPresent(findTestObject('saucedemo.com/Checkout/Alert CO Information/alert_Postal Code is required'), 0)
